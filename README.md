...
```bash
git clone https://github.com/PKusch/remit.git && cd remit && ./install.sh
```
...
**→ [Live control room](https://pkusch.github.io/remit/dashboard/)** — the estate on the
...
```bash
git clone https://github.com/PKusch/remit.git
cd remit && ./install.sh
```
